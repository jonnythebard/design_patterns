...
"""
Flyweight is a space optimization that lets us use less memory by
1) storing the data externally
2) specifying the index into the external data 
"""
...
class User2:
    strings = []    # uses class variable as in-memory db
